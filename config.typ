...
#let template = tufted.tufted-web.with(
  ...
  website-url: "https://voiddreamz.github.io",
  ...
  header-elements: (
    [DreamZ's Personal Space],
  ),
  /// 自定义页脚元素列表 (content 数组)，显示在页面底部。
  footer-elements: (
    "© 2024-2026 VoidDreamZ",
    [Powered by #link("https://github.com/Yousa-Mirage/Tufted-Blog-Template")[Tufted] and Typst],
  ),
)
