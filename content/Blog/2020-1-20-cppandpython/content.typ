...
于是我就开始学习C++，但是基础学的不大牢 #strike[（于是现在从C开始学）]
，现在没什么成果。
...
有段时间没碰C++了#strike[（也就一周）]，今日学C++厌烦了，新建了个Python文件，下笔就是个
\` \#include using namespace std; int main(){

} \` 原来这不是C++啊。 Python就是一片空白。 思绪突然被打断，关闭了vim。
...
如今这C++也因基础不牢而从头学起了C
#strike[\(说起来也惭愧，别人提起了数组，竟然不知何为数组)]。
