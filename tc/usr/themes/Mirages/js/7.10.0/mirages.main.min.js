...
Y();ca();X()},setupLazyLoadImage:function(){S()},setupCDNImageOptimize:function(){T()},version:function(){console.log("Mirages.version = "+LocalConst.THEME_VERSION);console.log("Mirages.js.version = 7.10.0.DEV7(191201A)")},highlightCodeBlock:function(){Z()},renderFlowChart:function(){aa()},renderMermaid:function(){ba()},doPJAXClickAction:function(){sa();a("body").attr("data-prev-href",g.location.pathname+g.location.search+g.location.hash).removeClass("display-menu-tree");a("#wrap").removeClass("display-menu-tree");
